...
public class ContohAljabar extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_contoh_aljabar);
    }

    public void GoToMenuUtama(View view) {
        Intent IntMenuUtama = new Intent(ContohAljabar.this, MainActivity.class);
